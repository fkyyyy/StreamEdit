...
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/egoedit_907_oracle_role_residual}"
STEP="${STEP:-15}"
CUDA_DEVICE="${CUDA_DEVICE:-0}"
CONTACT_TARGET_WEIGHT="${CONTACT_TARGET_WEIGHT:-0.7}"
ROUTING_MODE="${ROUTING_MODE:-oracle_role_residual}"
...
python inference_edit_streamedit.py \
  ...
  --save_path "$OUTDIR/907-${ROUTING_MODE//_/-}.mp4" \
