...
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/925a_consistent_kv_metadata}"
OUTPUT_NAME="${OUTPUT_NAME:-925a-consistent-kv-metadata.mp4}"
...
# Strict single-variable ablation against 924a. The only added model-control
# flag makes clean target-KV foreground metadata match the causal-owner role
# mask already used during denoising.
