...
OUTPUT_NAME="${OUTPUT_NAME:-910-target-owned-handoff.mp4}"
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/910_target_owned_handoff}"
STEP="${STEP:-15}"
...
TARGET_OWNED_MIN_SIMILARITY="${TARGET_OWNED_MIN_SIMILARITY:-0.55}"
...
python inference_edit_streamedit.py \
  ...
  --target_owned_min_similarity "$TARGET_OWNED_MIN_SIMILARITY" \
