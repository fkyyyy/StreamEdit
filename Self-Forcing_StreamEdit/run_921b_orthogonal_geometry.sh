...
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/921b_orthogonal_geometry}"
OUTPUT_NAME="${OUTPUT_NAME:-921b-orthogonal-geometry.mp4}"
...
FACTORIZED_GEOMETRY_STRENGTH="${FACTORIZED_GEOMETRY_STRENGTH:-1.0}"
...
"$PYTHON_BIN" inference_edit_streamedit.py \
  ...
  --factorized_geometry_strength "$FACTORIZED_GEOMETRY_STRENGTH" \
