...
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/917b_source_geometry_envelope}"
OUTPUT_NAME="${OUTPUT_NAME:-917b-source-geometry-envelope.mp4}"
...
IDENTITY_RESIDUAL_CONSTRAINT_STRENGTH="${IDENTITY_RESIDUAL_CONSTRAINT_STRENGTH:-0.35}"
IDENTITY_RESIDUAL_CONSTRAINT_POWER="${IDENTITY_RESIDUAL_CONSTRAINT_POWER:-2.0}"
SOURCE_GEOMETRY_STRENGTH="${SOURCE_GEOMETRY_STRENGTH:-0.35}"
SOURCE_GEOMETRY_POWER="${SOURCE_GEOMETRY_POWER:-2.0}"
SOURCE_GEOMETRY_MARGIN="${SOURCE_GEOMETRY_MARGIN:-1}"
...
"$PYTHON_BIN" inference_edit_streamedit.py \
  ...
  --identity_residual_constraint_strength "$IDENTITY_RESIDUAL_CONSTRAINT_STRENGTH" \
  --identity_residual_constraint_power "$IDENTITY_RESIDUAL_CONSTRAINT_POWER" \
