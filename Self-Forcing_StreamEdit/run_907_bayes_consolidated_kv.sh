...
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/907_bayes_consolidated_kv}"
STEP="${STEP:-15}"
...
python inference_edit_streamedit.py \
  ...
  --save_path "$OUTDIR/907-bayes-consolidated-kv.mp4" \
  --save_role_dir "$OUTDIR/roles" \
  --routing_mode hand_role_bayes_flow_consolidated_kv \
