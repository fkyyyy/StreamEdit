...
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/918_factorized_bayes_bridge}"
OUTPUT_NAME="${OUTPUT_NAME:-918-factorized-bayes-bridge.mp4}"
...
"$PYTHON_BIN" inference_edit_streamedit.py \
  ...
  --routing_mode hand_role_factorized_bayes_kv \
