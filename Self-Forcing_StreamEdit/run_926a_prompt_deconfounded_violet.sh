...
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/926a_prompt_deconfounded_violet}"
OUTPUT_NAME="${OUTPUT_NAME:-926a-prompt-deconfounded-violet.mp4}"
...
# Prompt-only ablation against 925a: use a scene-disjoint color and noun-only
# grounding while retaining the same model controls. Optional arguments are
# forwarded so 926b can add exactly one velocity-routing flag.
