...
OUTDIR="${OUTDIR:-$SCRIPT_DIR/outputs/924a_prepool_owner_visibility}"
OUTPUT_NAME="${OUTPUT_NAME:-924a-prepool-owner-visibility.mp4}"
...
# Strict single-variable ablation against 923a. The only added model-control
# flag excludes the hand per pixel frame before causal temporal pooling.
